...
Gem::Specification.new do |s|
  ...
  s.required_ruby_version = Gem::Requirement.new([">= 3.1.0".freeze, "< 3.5.0".freeze])
  ...
  s.add_development_dependency(%q<rbs>.freeze, ["~> 3.6.0".freeze])
  s.add_development_dependency(%q<rspec>.freeze, ["~> 3.13.0".freeze])
  s.add_development_dependency(%q<steep>.freeze, ["~> 1.8.0".freeze])
end
